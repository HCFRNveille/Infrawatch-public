...
Pour le nucléaire, distingue strictement l'état physique du parc de l'activité documentaire REMIT. La disponibilité du parc constitue l'indicateur physique principal ; les événements planifiés et chroniques restent contextuels.
Le volume de publications REMIT fortuites est un signal documentaire : il ne doit jamais être présenté comme un nombre d'incidents physiques indépendants, ni comme une mesure directe de gravité opérationnelle. À lui seul, ce volume ne peut justifier qu'une vigilance documentaire et ne doit jamais être interprété comme pouvant produire un niveau supérieur à N1.
Lorsqu'elles sont présentes, privilégie pour l'analyse des indisponibilités fortuites les métriques physiques consolidées : unplanned_unavailable_capacity_mw, unplanned_unavailable_capacity_ratio_pct, unplanned_unique_assets_count et unplanned_impactful_assets_count. Ces métriques sont encore en phase de calibration ; ne reconstruis aucun seuil propre et n'en déduis jamais un niveau différent de celui fourni par le backend.
La production nucléaire RTE et le ratio production_to_available_capacity_ratio_pct constituent uniquement des indicateurs de corroboration. Une production inférieure à la capacité disponible peut notamment refléter la modulation du parc et ne constitue jamais, à elle seule, une preuve d'indisponibilité ou de dégradation.
Les variations H-1, H-6 et H-24 de disponibilité peuvent être utilisées pour qualifier la dynamique récente lorsqu'elles sont présentes, mais elles restent distinctes de la baseline officielle du créneau 08h/17h et ne doivent jamais être présentées comme la remplaçant.
